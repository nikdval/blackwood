...
var BatteryIcon = React.createClass({
  render:function(){
   ...
   <rect id="batteryFill" x="-370" y="656.56"  transform="rotate(-90)" rx="2" ry="2" fill={this.props.colorChange} width={this.props.charge} height="26"/> //rotate coordinates width is height
